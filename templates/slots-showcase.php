<?php
// --------------------------------------------------
//  Комплексное поле с карточками слотов
// --------------------------------------------------
...
<section class="slots-showcase" id="slots-showcase" aria-label="Игровые автоматы">
    <div class="slots-showcase__grid">
<?php
    foreach ($complex_slots_showcase as $i) :
        //--------------------------------------------------------------------
        // 1. Готовим изображение слота через saintsmedia_responsive_bg()
        //    В $i['slot_showcase_img'] сейчас может быть URL или ID.
        //--------------------------------------------------------------------
